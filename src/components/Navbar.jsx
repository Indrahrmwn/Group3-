...
export default function Navbar({ transparent = false }) {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-4 group">
              <div className="relative overflow-hidden rounded-xl p-1">
                <img
                  ...
                  alt="Remaja Tengah"
                  className="w-10 h-10 sm:w-12 sm:h-12 object-contain transition-all duration-500 group-hover:scale-110"
                />
              </div>
              <div className="hidden sm:block">
                <h1
                  className={`font-bold text-base sm:text-xl tracking-tight transition-all duration-500 ${
            ...
            <div className="hidden lg:flex items-center gap-6">
              <nav className="flex items-center gap-1">
                ...
                <div className="relative dropdown-container">
                  ...
                  <div
                    className={`absolute top-full mt-3 left-0 w-56 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 py-3 z-50 transform transition-all duration-300 ${
                      aboutDropdownOpen
                  ...
                  >
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center group-hover:bg-red-100 transition-colors duration-200">
                        <svg
                          className="w-4 h-4 text-blue-600 group-hover:text-red-600 transition-colors duration-200"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-purple-100 flex items-center justify-center group-hover:bg-red-100 transition-colors duration-200">
                        <svg
                          className="w-4 h-4 text-purple-600 group-hover:text-red-600 transition-colors duration-200"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
              ...
              <div className="relative dropdown-container">
                ...
                >
                  <div
                    className={`relative w-10 h-10 rounded-xl overflow-hidden transition-all duration-300 group-hover:scale-110 group-hover:rotate-6 ${
                      showTransparent
                ...
                <div
                  className={`absolute top-full mt-3 right-0 w-64 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 py-3 z-50 transform transition-all duration-300 ${
                    profileDropdownOpen
                      ? "opacity-100 translate-y-0 scale-100"
                      : "opacity-0 -translate-y-2 scale-95 pointer-events-none"
                  }`}
                  ...
                  {user && localStorage.getItem("token") ? (
                    <>
                      ...
                      >
                        ...
                        <div>
                          <p className="font-medium">My Ticket</p>
                          <p className="text-xs text-gray-500">
                            View your tickets
                          </p>
                        </div>
            ...
            <div className="flex lg:hidden items-center gap-2 sm:gap-3">
              <Link
                to="/detail-ticket"
                className={`px-3 sm:px-4 py-2 font-bold text-xs rounded-lg transition-all ${
                  showTransparent
      ...
      {/* Mobile Menu Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white z-50 lg:hidden shadow-2xl transform transition-transform duration-300 ease-out ${
          mobileMenuOpen ? "translate-x-0" : "translate-x-full"
        }`}
      >
        <div className="h-full overflow-y-auto">
          {/* Mobile Menu Header */}
          <div className="sticky top-0 bg-gradient-to-r from-red-600 to-red-700 p-6 text-white z-10">
            ...
            {user && localStorage.getItem("token") ? (
              ...
              <div className="bg-white/10 rounded-xl p-4 text-center">
                <p className="text-sm mb-2">Welcome! Please sign in</p>
                <Link
                  to="/login"
          ...
          <nav className="p-4 space-y-2">
            <Link
              to="/"
              className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-red-50 hover:text-red-600 transition-colors font-medium"
              onClick={() => setMobileMenuOpen(false)}
            >
              <svg
                className="w-5 h-5"
            ...
            <div className="space-y-1">
              <button
                ...
                className={`flex items-center justify-between w-full px-4 py-3 rounded-xl transition-all duration-300 font-medium ${
                  mobileAboutOpen
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 ${
                      mobileAboutOpen ? "bg-red-100" : "bg-gray-100"
                    }`}
                  >
                    <svg
                      className="w-5 h-5"
              ...
              {/* About Submenu - Dengan Animasi Smooth */}
              <div
              ...
              >
                <div className="overflow-hidden">
                  <div className="ml-12 space-y-1 py-2">
                    <Link
                      to="/about"
                      className="group flex items-center gap-3 px-4 py-2.5 text-sm text-gray-600 hover:text-red-600 rounded-lg hover:bg-red-50 transition-all duration-200"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      <div className="w-2 h-2 rounded-full bg-gray-300 group-hover:bg-red-500 group-hover:scale-125 transition-all duration-200"></div>
            ...
            {user && localStorage.getItem("token") && (
              <>
                ...
                <Link
                  to="/ticket-user"
                  className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors font-medium"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <svg
                    className="w-5 h-5"
            ...
            {!user && (
              <>
                ...
                <Link
                  to="/register"
                  className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-green-600 text-white hover:bg-green-700 transition-colors font-bold"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <svg
                    className="w-5 h-5"
                ...
                <Link
                  to="/login"
                  className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition-colors font-bold"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <svg
                    className="w-5 h-5"
