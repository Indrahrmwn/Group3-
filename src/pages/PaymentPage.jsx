      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-red-600 to-red-700 p-6">
            ...
            <p className="text-red-100 text-sm mt-1">Lengkapi data dan lakukan pembayaran</p>
          </div>

          <div className="p-6 space-y-6">
            {/* Order Summary */}
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-5 border border-red-200">
              <h3 className="font-bold text-lg mb-4 text-gray-900">Detail Pesanan</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{orderData.quantity} tiket</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="border-t border-red-300 pt-3 flex justify-between">
                  ...
                  <span className="font-bold text-red-600 text-xl">{formatPrice(orderData.total)}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="font-bold text-lg mb-4 text-gray-900">Data Pembeli</h3>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-blue-900 text-sm mb-1">Metode Pembayaran</p>
                  <p className="text-xs text-blue-700">
                    Anda akan diarahkan ke halaman pembayaran Midtrans untuk memilih metode pembayaran (QRIS, GoPay, OVO, DANA, Bank Transfer, dll)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                ...
                className={`flex-1 py-3 rounded-xl font-bold transition-all ${
                  loading || !customerInfo.name || !customerInfo.email || !customerInfo.phone
