...
export default function TicketPage() {
  ...
  const handleProceedToPayment = () => {
    ...
    navigate("/payment", { state: { ticketOrder: orderData } });
  };
            ...
            <div className="sticky top-24">
              <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-red-600 to-red-700 p-6">
                  ...
                  <div className="flex items-center justify-between text-xs mb-3">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-white text-red-600 rounded-full flex items-center justify-center font-bold">
                        1
                      </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-white/20 text-white rounded-full flex items-center justify-center font-bold">
                        2
                      </div>
                ...
                <div className="p-6">
                  {orderData ? (
                      ...
                      <div className="space-y-4 mb-6">
                        ...
                        <div className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="font-semibold text-gray-900">
                              {orderData.quantity} ticket
                              {orderData.quantity > 1 ? "s" : ""}
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-400 text-xs">
                        Choose your ticket, session,
                        <br />
                        and quantity to see the summary
                      </p>
                    </div>
                  )}
                  ...
                  {/* Warning Message */}
                  {orderData &&
                    (!orderData.session || orderData.quantity === 0) && (
                      <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-xl flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-yellow-700">
                            Please complete all required fields on the left to
                            continue
                          </p>
                        </div>
                      </div>
